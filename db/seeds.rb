...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  box_gloves = Offer.new(title: 'Box gloves', description: 'Good condition', category: ['Fighting sports'].sample, price: '10', location: 'Klingelhöferstraße 14, 10785 Berlin', pick_up_at: '2020-12-03 19:00:00', host_id: 2)
  ...
  tennis_racket = Offer.new(title: 'Tennis racket', description: 'Light racket in good condition, really nice to play tennis with it.', category: ['Racket sports'].sample, price: '12', location: 'Niederkirchnerstraße 7, 10963 Berlin', pick_up_at: '2020-12-03 19:00:00', host_id: 1)
