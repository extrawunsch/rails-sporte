...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  snowboard = Offer.new(title: 'Snowboard', description: 'In perfect condition, used only once', category: ['Winter sports'].sample, price: '20', location: 'Neue Jakobstraße 6/7, 10179 Berlin', pick_up_at: '2020-12-03 19:00:00', host: niklas)
  ...
  exercise_ball = Offer.new(title: 'Large exercise ball', description: 'Good condition, already used a few times', category: ['Ball sports', 'Gym equipment'].sample, price: '5', location: 'Am Kupfergraben 4/4a, 10117 Berlin', pick_up_at: '2020-12-19 09:00:00', host: niklas)
  ...
  kettlebell = Offer.new(title: '12 kettlebell', description: 'Used a lot but still good condition', category: ['Gym equipment'].sample, price: '20', location: 'Marheinekepl. 1, 10961 Berlin', pick_up_at: '2020-12-03 19:00:00', host: agnes)
  ...
  rugby_ball = Offer.new(title: 'Rugby ball', description: 'NEW, never used', category: ['Ball sports', 'Gym equipment'].sample, price: '6', location: 'Schönhauser Allee 185, Berlin', pick_up_at: '2020-12-19 12:00:00', host: niklas)
  ...
  surf_plank = Offer.new(title: 'Surf plank', description: 'New, never used', category: ['Winter sports'].sample, price: '12', location: 'Sorauer Str. 6, 10997 Berlin', pick_up_at: '2020-12-03 19:00:00', host: agnes)
  ...
  snowshoes = Offer.new(title: 'Snowshoes & ski sticks', description: 'Good condition', category: ['Winter sports'].sample, price: '30', location: 'Eisenbahnstraße 42/43, 10997 Berlin', pick_up_at: '2020-12-01 17:00:00', host: ramona)
  ...
  windsurf_equipment = Offer.new(title: 'Windsurf equipment', description: 'Barely used, perfect condition', category: ['Water sports'].sample, price: '40', location: 'Invalidenstraße 43, 10115 Berlin', pick_up_at: '2020-12-01 21:00:00', host: christoph)
  ...
  yoga_mat = Offer.new(title: 'Yoga mat', description: 'Good condition, used 2 times', category: ['Gym equipment', 'Yoga equipment'].sample, price: '4', location: 'Palisadenstraße 48, 10243 Berlin', pick_up_at: '2020-12-01 21:00:00', host: christoph)
  ...
  kayak = Offer.new(title: 'Inflatable kayak', description: 'Good condition', category: ['Water sports'].sample, price: '10', location: 'Mittenwalder Str. 30, 10961 Berlin', pick_up_at: '2020-12-03 19:00:00', host: ramona)
  ...
  box_gloves = Offer.new(title: 'Box gloves', description: 'Good condition', category: ['Fighting sports'].sample, price: '10', location: 'Klingelhöferstraße 14, 10785 Berlin', pick_up_at: '2020-12-03 19:00:00', host: christoph)
  ...
  tennis_racket = Offer.new(title: 'Tennis racket', description: 'Light racket in good condition, really nice to play tennis with it.', category: ['Racket sports'].sample, price: '12', location: 'Niederkirchnerstraße 7, 10963 Berlin', pick_up_at: '2020-12-03 19:00:00', host: agnes)
